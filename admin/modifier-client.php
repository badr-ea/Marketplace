...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto my-8 px-4">
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-6">
            ...
            <form action="modification-client.php" method="POST">
            <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nom_utilisateur" name="nom_utilisateur" class="px-4 py-2 border rounded-lg w-full focus:outline-none focus:border-blue-500">
                </div>
