...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto my-8 px-4">
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-6">
            ...
            <form action="modification-cat.php" method="POST" enctype="multipart/form-data">
                <div class="mb-4">
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Modifier Catégorie</button>
            </form>
        </div>
    </div>
