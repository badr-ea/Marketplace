...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto my-8 px-4">
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-6">
            <h1 class="text-2xl font-bold mb-4">Supprimer un Produit</h1>
            <form action="suppression-produit.php" method="POST">
                <div class="mb-4">
                ...
                <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Supprimer Produit</button>
            </form>
        </div>
    </div>
</body>
